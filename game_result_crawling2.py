...
def soup_to_dataframe(url, soup, path):
  ...
  for latten_half in range(2):
    ...
    batter_all_result = soup.find_all("div", class_="scroll_wrapper table_score table_batter")[latten_half].find("tbody").find_all("tr")
    ...
    pitcher_all_result = soup.find_all("div", class_="scroll_wrapper table_score table_pitcher")[latten_half].find("tbody").find_all("tr")
